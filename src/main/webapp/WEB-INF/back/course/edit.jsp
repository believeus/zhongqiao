    ...
    <div class="x-body">
        <form class="layui-form">
          <input  name="id" type="hidden" value="${course.id }"/>
           <input  name="createTime" type="hidden" value="${course.createTime }"/>
          <div class="layui-form-item">
              <label for="L_email" class="layui-form-label">
               <span class="x-red">*</span>课程分类: 	
              </label>
              <div class="layui-input-inline" >
               <input id="category_id" name="category_id" type="hidden" value="${course.category.id }">
               <input id="categorySel" readonly="" value="${course.category.name }" lay-verify="required" placeholder="点击选择" class="layui-input" onclick="showMenu(); return false;">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input  name="name" value="${course.name }" lay-verify="required"  autocomplete="off" class="layui-input">
              </div>
          </div>
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                   <input name="vidHour" value="${course.vidHour}" lay-verify="required"  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  <input name="studyTime" value="${course.studyTime }" lay-verify="required"  autocomplete="off" class="layui-input">
              </div>
          </div>
           <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  	<textarea rows="10" cols="38" maxlength="255" name="introduce"  lay-verify="required" class="tarea">${ course.introduce}</textarea>
              </div>
          </div>
          <div class="layui-form-item">
