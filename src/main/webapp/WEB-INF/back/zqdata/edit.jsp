...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" >
                <input id="category_id" name="categoryId" type="hidden" value="${zqdata.zqmeta.id}">
                <input id="categorySel" readonly="" value="${zqdata.zqmeta.name}" lay-verify="required" class="layui-input" onclick="showMenu(); return false;">
            </div>
        </div>
