        ...
        <input type="hidden" name="id" value="${task.id}" >
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" value="${task.title }"  name="title" lay-verify="required" autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item" >
          ...
          <div id="form-value" class="layui-form-item" style="display: none;">
              ...
              <div class="layui-input-inline">
                  <input  value="${task.status}" readonly="readonly" name="status" id="status"  lay-verify="required"  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item" >
